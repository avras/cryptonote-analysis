        ...
        if tx_hashes != []:
            ...
            for tx in rt['txs']:
                ...
                for txi in txinputs:
                    ...
                    cur.execute('INSERT INTO xmrv9_keyimages (image, ring_amount, ring_indices, block_height) VALUES(%s, %s, %s, %s) ON CONFLICT(image) DO NOTHING;', (keyimage, amount, keyindices, blockheight))
                    for ki in keyindices:
                        ...
                        cur.execute('INSERT INTO xmrv9_outputs (address, amount, index) VALUES(%s, %s, %s) ON CONFLICT(amount, index) DO NOTHING;', (address, amount, ki))
            conn.commit()
